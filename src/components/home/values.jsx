        ...
        query={graphql`
          {
            content: markdownRemark(
              frontmatter: { section: { eq: "values" }, page: { eq: "home" } }
            ) {
              frontmatter {
                title
                subtitle
                    ...
                    <ScrollAnimation animateIn="bounceInUp" animateOnce>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="feature-wrap">
                          <div class="icon-wrap">
                            <i
                              class={`fa fa-${data.content.frontmatter.firstPointFontAwesomeIcon}`}
                            ></i>
                          </div>
                    ...
                    <ScrollAnimation animateIn="bounceInUp" animateOnce>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="feature-wrap">
                          <div class="icon-wrap">
                            <i
                              class={`fa fa-${data.content.frontmatter.secondPointFontAwesomeIcon}`}
                            ></i>
                          </div>
                    ...
                    <ScrollAnimation animateIn="bounceInUp" animateOnce>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="feature-wrap">
                          <div class="icon-wrap">
                            <i
                              class={`fa fa-${data.content.frontmatter.thirdPointFontAwesomeIcon}`}
                            ></i>
                          </div>
                    ...
                    <ScrollAnimation animateIn="bounceInUp" animateOnce>
                      <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="feature-wrap">
                          <div class="icon-wrap">
                            <i
                              class={`fa fa-${data.content.frontmatter.fourthPointFontAwesomeIcon}`}
                            ></i>
                          </div>
