              ...
              <ScrollAnimation animateIn="bounceInUp" animateOnce>
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <h2 class="lg-title text-center">
                    <span>What People Say about ILYMUN?</span>
                  </h2>
...
LandingQuotes.defaultProps = {
  quotes: [
    {
      quote:
        "For me as a journalist it's always very interesting to interact with young people,  just to see how interested they are in the world around them,  the realities of the world, and how they prepare for them.",
      author: "Peter Barabas, Chief Editor at Euronews"
    },
    {
      quote:
        "It's a gathering of young people who are comming up with fresh ideas, who are practicing a kind of methodology which I find absolutely needed to tackle today's problems.",
