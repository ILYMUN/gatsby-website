...
$.fn.final_countdown = function(options, callback) {
  ...
  if (element.data("border-color")) {
    settings.seconds.borderColor = settings.minutes.borderColor = settings.hours.borderColor = settings.days.borderColor = element.data(
      "border-color"
    );
  }
  ...
  circleDays = new Kinetic.Shape({
    drawFunc: function(context) {
      ...
      context.arc(
        ...
        radius,
        convertToDeg(0),
        convertToDeg((timer.days * 360) / 365)
      );
      context.fillStrokeShape(this);
